...
CREATE TABLE `import_job` (
    ...
    `range` VARCHAR(191) NOT NULL DEFAULT 'all',
    ...
    INDEX `import_job_userId_idx`(`userId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `scrobble` (
    ...
    `durationMs` INTEGER NOT NULL DEFAULT 210000,

    INDEX `scrobble_userId_idx`(`userId`),
    INDEX `scrobble_userId_playedAt_idx`(`userId`, `playedAt`),
    UNIQUE INDEX `scrobble_userId_playedAt_key`(`userId`, `playedAt`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
